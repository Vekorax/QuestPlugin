package qc.veko.quest.commands.engine;
...
public @interface Command {
	 ...
	 * @return
	 */
	public String noPerm() default "§cTu n'as pas la permission pour exécuter cette commande.";
	 ...
	 * @return
	 */
	public String usage() default "aa";
